...
You can also serve [BLOOMZ](https://huggingface.co/bigscience/bloomz), a version of BLOOM fine-tuned to better follow human instructions in the zero-shot regime — just replace `bloom-petals` with `bloomz-petals`.
