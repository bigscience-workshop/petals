...
You can also serve [BLOOMZ](https://huggingface.co/bigscience/bloomz), a version of BLOOM fine-tuned to follow human instructions — just replace `bloom-petals` with `bloomz-petals`.
