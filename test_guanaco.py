...
from petals import DistributedBloomForCausalLM, DistributedLlamaForCausalLM
...
distr_model = DistributedLlamaForCausalLM.from_pretrained(
    MODEL_NAME, torch_dtype=torch.bfloat16, active_adapter=ADAPTER_NAME
).to(DEVICE)
